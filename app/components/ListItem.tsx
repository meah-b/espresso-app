  ...
  const SelectedListItem = () => (
    <View style={styles.largeContainer}>
      ...
      <View style={styles.infoContainer}>
        <Text style={[styles.text, styles.selectedText, {marginBottom: 12, marginTop: 5}]}>Espresso Bean: {espressoBean}</Text>
        <Text style={[styles.text, styles.selectedText, {marginBottom: 12}]}>Extraction Duration: {extractionDuration} seconds</Text>
        <Text style={[styles.text, styles.selectedText, {marginBottom: 5}]}>Grind Size: {grindSize}</Text>
